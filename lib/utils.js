...
module.exports = {
  ...
  getHTML: function(url, cb) {
    ...
    var html = '';
    var stream = request({ url: url, headers: { 'User-Agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/38.0.2125.104 Safari/537.36' }});
